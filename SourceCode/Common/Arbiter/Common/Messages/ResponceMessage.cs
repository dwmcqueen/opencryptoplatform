...
namespace Arbiter
{
    ...
    /// </summary>
    [Serializable]
    public class ResponceMessage : TransportMessage
    {
        ...
        /// 
        /// </summary>
        public ResponceMessage(bool operationResult)
        {
        ...
        public ResponceMessage(bool operationResult, string errorMessage)
        {
            _operationResult = operationResult;
        ...
        /// 
        /// </summary>
        public ResponceMessage(bool operationResult, Exception exception)
        {
            _operationResult = operationResult;
        ...
        /// 
        /// </summary>
        public void CopyParameters(ResponceMessage message)
        {
